...
export const RelatorioAnualPage: React.FC = () => {
    ...
    const { pdfState, startPdfDownload, retryPdfDownload, closePdfModal } = usePdfDownload(relatorioService.getApiBaseUrl());
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex gap-3 items-center">
                        ...
                        <button
                            ...
                            className="bg-cyber-gold text-black px-4 py-2 rounded font-oxanium font-bold hover:bg-yellow-400 transition-all flex items-center gap-2"
                        >
